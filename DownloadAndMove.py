...
from_dir = "/Users/apple/Downloads"              # Add the path of you "Downloads" folder.
to_dir = "/Users/apple/Desktop/Downloaded_files_waste" #Create "Document_Files" folder in your Desktop and update the path accordingly.
